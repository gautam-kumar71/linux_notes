...
#note
 **`In C++, once you write an **access specifier** like `public:`, everything **after that** (until another access specifier like `private:` or `protected:`) will be treated with that access level.`
---
### 🧪Example 1
``` cpp
#include <iostream>
